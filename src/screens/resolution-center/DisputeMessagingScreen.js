...
const DisputeMessagingScreen = ({ route }) => {
  ...
  const loadMessages = async () => {
    try {
      const response = await disputeService.getDisputeMessages(disputeId);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      await disputeService.sendDisputeMessage(disputeId, message);
      await loadMessages();
...
export default DisputeMessagingScreen;