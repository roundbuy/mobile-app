    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <ScrollView style={styles.content}>
                ...
                {/* Title */}
                <Text style={styles.titleLeft}>{t("Buyer's Refund Eligibility criteria Buyer-to-Buyer (C2C)")}</Text>

                {/* Information List */}
                <View style={styles.infoSection}>
                    <Text style={styles.sectionHeader}>{t('Reasons for Buyer Disputes')}</Text>
