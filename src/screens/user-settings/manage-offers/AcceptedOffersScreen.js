...
const AcceptedOffersScreen = ({ navigation }) => {
  const offers = [
    {
      ...
      type: 'RENT',
      acceptedPrice: '£250.00',
      date: '12.10.2025',
      status: 'Accepted',
      message: 'You Accepted the offer at 24.10.2025. This offer is simply open recorded',
      image: IMAGES.chair1,
    },
    {
      id: 2,
  ...
  const handleSchedulePickup = (offer) => {
    console.log('Schedule pickup for:', offer);
  };
  ...
  const renderOffer = ({ item }) => (
    <View style={styles.offerCard}>
      <View style={styles.offerHeader}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.acceptedText}>
            You <Text style={styles.boldText}>Accepted</Text> the offer at {item.date}.
          </Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => handleSchedulePickup(item)}
      >
